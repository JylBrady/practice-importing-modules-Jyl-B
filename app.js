...
taskManager.addTask(taskList, 'Clean room');  // 2. Add new tasks to the list. 
taskManager.addTask(taskList, 'Wash Car');
taskManager.addTask(taskList, 'Take Out Trash');
taskManager.listTasks(taskList);  //         3. List all tasks. 

fileHandler.saveTasks('tasks.json', taskList);  //         4. Save the updated task list back to the file. 
